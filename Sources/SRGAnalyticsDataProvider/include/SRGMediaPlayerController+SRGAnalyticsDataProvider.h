 ...
 *
 *  For more information about stream measurements, @see SRGMediaPlayerController+SRGAnalyticsMediaPlayer.h.
 */
@interface SRGMediaPlayerController (SRGAnalyticsDataProvider)
