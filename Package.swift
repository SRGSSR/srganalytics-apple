...
struct ProjectSettings {
    static let marketingVersion: String = "7.8.1"
}
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SRGDataProvider", url: "https://github.com/SRGSSR/srgdataprovider-apple.git", .upToNextMinor(from: "16.0.0")),
        ...
        .package(name: "SRGMediaPlayer", url: "https://github.com/SRGSSR/srgmediaplayer-apple.git", .upToNextMinor(from: "7.0.2")),
