...
struct ProjectSettings {
    static let marketingVersion: String = "7.4.1"
}
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SRGDataProvider", url: "https://github.com/SRGSSR/srgdataprovider-apple.git", .upToNextMinor(from: "13.0.0")),
        ...
        .package(name: "SRGMediaPlayer", url: "https://github.com/SRGSSR/srgmediaplayer-apple.git", .branch("feature/playback-speed")),
