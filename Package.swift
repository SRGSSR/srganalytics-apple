...
struct ProjectSettings {
    static let marketingVersion: String = "7.7.1"
}
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SRGContentProtection", url: "https://github.com/SRGSSR/srgcontentprotection-apple.git", .branch("feature/ios16-tvos16-xcode14")),
        .package(name: "SRGDataProvider", url: "https://github.com/SRGSSR/srgdataprovider-apple.git", .branch("feature/ios16-tvos16-xcode14")),
        ...
        .package(name: "SRGMediaPlayer", url: "https://github.com/SRGSSR/srgmediaplayer-apple.git", .branch("feature/ios16-tvos16-xcode14")),
