...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "TCCore", url: "https://github.com/SRGSSR/TCCore-xcframework-apple.git", .exact("4.5.4-srg4")),
        .package(name: "TCSDK", url: "https://github.com/SRGSSR/TCSDK-xcframework-apple.git", .exact("4.4.1-srg4"))
    ],
    targets: [
        .target(
            name: "SRGAnalytics",
